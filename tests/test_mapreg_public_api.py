...
def test_public_api_is_the_declared_coupling_interface():
    ...
    assert callable(fit_context_conditional_log_odds)
    ...
    assert callable(predict_context_log_odds)
    ...
    assert (
        ContextConditionalCouplingFit.__module__
        == "mapreg.context_conditional_coupling"
    )
